...
\item What are some resources for aditional learning?
\end{itemize}
\end{frame}
...
\hlkwd{aggreswmp}\hlstd{(swmpr_in,} \hlkwc{FUN} \hlstd{= fun_in,} \hlstr{'years'}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{itemize}
...
{\centering \includegraphics[width=0.9\textwidth]{figure/unnamed-chunk-23-1} 
...
{\centering \includegraphics[width=\textwidth]{figure/unnamed-chunk-25-1} 
