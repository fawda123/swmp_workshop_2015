...
png('figures/diag_plots.png', height = 6, units = 'in', res = 300)
pairs(sub_dat)
dev.off()

png('figures/hist.png', height = 5, units = 'in', res = 300)
hist(sub_dat$sal, xlab = 'Salinity', main = 'Histogram')
dev.off()

png('figures/box.png', height = 5, units = 'in', res = 300)
...
# plot
png('figures/box_agg.png', height = 4.5, width = 8.5, units = 'in', res = 300)
